...
*/
		...
		var move2 = (string.indexOf('"moves":[[')+10).substring(string.indexOf('],[')+3, string.indexOf('"],[')).concat(lnen, lnmv)
	...
	var res = ln1p1.concat(species, ln1p2, ln2p1, ln2p2, ln2p3, ln3, ln4, hpev, atev, deev, saev, sdev, spev, ln11, ln12p1)	
